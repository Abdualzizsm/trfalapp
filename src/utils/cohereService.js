...
export async function createTravelPlan(travelData) {
  try {
    ...
    // إنشاء نص الطلب
    const prompt = `أنت مخطط سفر محترف ومتخصص. يرجى إنشاء خطة سفر مفصلة وشاملة باللغة العربية الفصحى لـ ${travelData.destination} بناءً على المعلومات التالية:
    ...
    يجب أن تتضمن الخطة العناصر التالية بشكل مفصل وواضح:
